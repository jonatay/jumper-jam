...
# filesystem menu plugin
var data_table_filesystem_menu: DataTableFilesystemMenuPlugin
...
func _enter_tree() -> void:
	...
	# custom filesystem menu
	data_table_filesystem_menu = DataTableFilesystemMenuPlugin.new()
	add_context_menu_plugin(EditorContextMenuPlugin.CONTEXT_SLOT_FILESYSTEM, data_table_filesystem_menu)
...
func _exit_tree() -> void:
	...
	# custom filesystem menu
	remove_context_menu_plugin(data_table_filesystem_menu)
